...
var author$project$Chargen$MainModel = function (a) {
	return {$: 'MainModel', a: a};
};
...
var author$project$Character$allRaces = elm$core$Set$fromList(
	_List_fromArray(
		['Dwarf', 'Elf', 'Gnome', 'HalfElf', 'Halfling', 'HalfOrc', 'Human']));
var author$project$Character$allClasses = elm$core$Set$fromList(
	_List_fromArray(
		['Assassin', 'Cleric', 'Druid', 'Fighter', 'Illusionist', 'MagicUser', 'Paladin', 'Ranger', 'Thief']));
...
var author$project$Character$raceAllowedClasses = function (race) {
	return A2(
				...
				_List_fromArray(
					[
						...
						elm$core$Set$fromList(
							_List_fromArray(
								['Assassin', 'Cleric', 'Fighter', 'Thief']))),
						_Utils_Tuple2('Human', author$project$Character$allClasses)
					]))));
};
...
var author$project$Character$allowedClassesForRaces = function (selectedRaces) {
	return A3(
		elm$core$Set$foldl,
		F2(
			function (r, cls) {
				return A2(
					elm$core$Set$union,
					cls,
					author$project$Character$raceAllowedClasses(r));
			}),
		elm$core$Set$empty,
		selectedRaces);
};
var author$project$Chargen$defaultFormData = {
	...
	maxLevel: 20,
	minLevel: 1,
	selectedClasses: author$project$Character$allowedClassesForRaces(author$project$Character$allRaces),
	selectedRaces: author$project$Character$allRaces
};
...
var author$project$Character$Character = F6(
	function (race, cClass, level, alignment, attributes, savingThrows) {
		return {alignment: alignment, attributes: attributes, cClass: cClass, level: level, race: race, savingThrows: savingThrows};
	});
...
var author$project$Character$characterDecoder = A3(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'race',
						elm$json$Json$Decode$string,
						elm$json$Json$Decode$succeed(author$project$Character$Character)))))));
var author$project$Chargen$GotCharacters = function (a) {
	return {$: 'GotCharacters', a: a};
};
var author$project$Chargen$baseUrl = 'https://chargen-api-5d4nndwdsq-lz.a.run.app';
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'minLevel',
				elm$json$Json$Encode$int(form.minLevel)),
				_Utils_Tuple2(
				'maxLevel',
				...
				_Utils_Tuple2(
				'attributeGen',
				elm$json$Json$Encode$string(form.attributeGen))
			]));
};
...
var author$project$Chargen$getRandomCharacters = function (form) {
	return elm$http$Http$post(
		{
			...
			expect: A2(
				...
				author$project$Chargen$GotCharacters,
				elm$json$Json$Decode$list(author$project$Character$characterDecoder)),
			url: author$project$Chargen$baseUrl + '/character'
		});
};
var author$project$Chargen$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Chargen$MainModel(
			{characters: _List_Nil, errorMessage: elm$core$Maybe$Nothing, form: author$project$Chargen$defaultFormData}),
		author$project$Chargen$getRandomCharacters(author$project$Chargen$defaultFormData));
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$Chargen$subscriptions = function (_n0) {
	return elm$core$Platform$Sub$none;
};
var author$project$Chargen$errorMessageFrom = function (err) {
	switch (err.$) {
		case 'BadStatus':
			var code = err.a;
				...
				if (httpResult.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						author$project$Chargen$MainModel(
							_Utils_update(
								content,
								{characters: newChars, errorMessage: elm$core$Maybe$Nothing})),
							...
							_Utils_update(
								content,
								{
									errorMessage: elm$core$Maybe$Just(
										author$project$Chargen$errorMessageFrom(e))
								})),
						elm$core$Platform$Cmd$none);
				}
					...
					return _Utils_Tuple2(
						author$project$Chargen$MainModel(
							_Utils_update(
								content,
								{
									characters: _Utils_ap(characters, newChars),
								...
								form: _Utils_update(
									form,
									{
										selectedClasses: A2(
											...
											author$project$Character$allowedClassesForRaces(
												elm$core$Set$fromList(newRaces))),
										selectedRaces: elm$core$Set$fromList(newRaces)
									})
							})),
					elm$core$Platform$Cmd$none);
						...
						_Utils_update(
							content,
							{
								form: _Utils_update(
									form,
									{
										selectedClasses: elm$core$Set$fromList(newClasses)
									})
							})),
					elm$core$Platform$Cmd$none);
...
var author$project$Chargen$GenerateMoreCharacters = {$: 'GenerateMoreCharacters'};
var elm$core$Basics$negate = function (n) {
	return -n;
};
var author$project$Character$getAttribute = F2(
	function (attributes, name) {
		return A2(
			elm$core$Maybe$withDefault,
			-1,
			A2(elm$core$Dict$get, name, attributes));
	});
...
var author$project$Chargen$attributesView = function (attributes) {
	var attrNames = _List_fromArray(
		['str', 'dex', 'con', 'int', 'wis', 'cha']);
	return A2(
		elm$html$Html$table,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('pure-table')
			]),
		_List_fromArray(
			[
				A2(
									...
									_List_fromArray(
										[
											...
											elm$core$String$fromInt(
												A2(author$project$Character$getAttribute, attributes, att)))
										]));
							},
							attrNames))
					]))
...
var author$project$Chargen$savingThrowsView = function (sthrs) {
	var stNames = _List_fromArray(
		['Magic items', 'Breath', 'Death', 'Petrify', 'Spells']);
	var stFields = _List_fromArray(
								...
								return A2(
									...
									_List_fromArray(
										[
											elm$html$Html$text(
											elm$core$String$fromInt(
												A2(author$project$Character$getAttribute, sthrs, st)))
										]));
							},
							stFields))
					]))
						...
						_List_fromArray(
							[
								...
								[
									...
									elm$html$Html$text(
									elm$core$String$fromInt(chr.level))
								]),
								_List_fromArray(
								[
									A2(
									...
									elm$html$Html$text(chr.alignment)
								])
							])),
					A2(
						elm$core$List$map,
						function (content) {
							return A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('pure-u-1-1 l-box')
									]),
								_List_fromArray(
									[content]));
						},
						_List_fromArray(
							[
								author$project$Chargen$attributesView(chr.attributes),
								author$project$Chargen$savingThrowsView(chr.savingThrows)
							]))))
			]));
};
var author$project$Chargen$characterListView = function (characters) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('characters-container')
			]),
		A2(elm$core$List$map, author$project$Chargen$characterView, characters));
};
var author$project$Chargen$errorMessageView = F2(
...
var author$project$Chargen$GenerateCharacters = {$: 'GenerateCharacters'};
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$value('Method3D6'),
										elm$html$Html$Attributes$checked(current === 'Method3D6'),
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$name('attributeGen'),
										elm$html$Html$Attributes$value('Method4D6BestOf3'),
										elm$html$Html$Attributes$checked(current === 'Method4D6BestOf3'),
										elm$html$Html$Events$onInput(author$project$Chargen$ChangeAttributeGen)
									]),
								_List_Nil),
...
var author$project$Chargen$optionsFromSet = F2(
	function (allOptions, allowedValues) {
		return A2(
			elm$core$List$map,
			function (s) {
				return {
					enabled: A2(elm$core$Set$member, s, allowedValues),
					text: s,
					value: s
				};
			},
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('pure-u-1 pure-u-md-1-5')
									]),
								_List_fromArray(
									[
									...
									[
										...
										_List_fromArray(
											[
												...
												{
													items: A2(author$project$Chargen$optionsFromSet, author$project$Character$allRaces, author$project$Character$allRaces),
												...
												_List_fromArray(
													[
														...
														elm$core$Set$size(author$project$Character$allRaces))
													]),
												elm$core$Set$toList(form.selectedRaces))
											]))
									])),
								A2(
								elm$html$Html$div,
									...
									[
										...
										_List_fromArray(
											[
												...
												{
													items: A2(
														author$project$Chargen$optionsFromSet,
														author$project$Character$allClasses,
														author$project$Character$allowedClassesForRaces(form.selectedRaces)),
												...
												_List_fromArray(
													[
														...
														elm$html$Html$Attributes$required(true),
														elm$html$Html$Attributes$size(
														elm$core$Set$size(author$project$Character$allClasses))
													]),
						...
						_List_fromArray(
							[
								A2(author$project$Chargen$errorMessageView, isInError, errorMessage),
								A2(
								elm$html$Html$button,
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('pure-button'),
										elm$html$Html$Events$onClick(author$project$Chargen$GenerateCharacters),
...
var author$project$Chargen$view = function (model) {
	...
	var characters = model.a.characters;
	var errorMessage = model.a.errorMessage;
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$id('app-header')
							]),
						_List_fromArray(
							[
						...
						A2(
						author$project$Chargen$errorMessageView,
						elm_community$maybe_extra$Maybe$Extra$isJust(errorMessage),
						'Well, that was a bad roll: ' + A2(elm$core$Maybe$withDefault, '', errorMessage))
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('pure-button'),
								elm$html$Html$Events$onClick(author$project$Chargen$GenerateMoreCharacters),
								A2(
								elm$core$Basics$composeL,
								A2(
									elm$core$Basics$composeL,
...
var author$project$Chargen$main = elm$browser$Browser$element(
	{init: author$project$Chargen$init, subscriptions: author$project$Chargen$subscriptions, update: author$project$Chargen$update, view: author$project$Chargen$view});
_Platform_export({'Chargen':{'init':author$project$Chargen$main(
