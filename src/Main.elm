            ...
            div [ class "content" ]
                [ Html.form [ class "pure-form pure-form-stacked" ]
                    [ fieldset []
                        ...
                        , div [ class "pure-g" ]
                            (List.map (\x -> div [ class "pure-u-1 pure-u-md-1-2" ] [ x ])
                                [ label []
                                    [ text "Min level"
                                ...
                                , label []
                                    [ text "Max level"
                                    , input [ class "pure-u-2-5", type_ "number", value (String.fromInt data.maxLevel), Html.Attributes.min "1", Html.Attributes.max "100", size 2 ] []
                                    ]
                                , label []
                                    [ text "Races"
...
raceOption race =
    option [ value race, selected True ] [ text race ]
